      ...
      <div className="absolute inset-0 flex items-center justify-center">
        <div className='w-full md:w-1/4 flex flex-col mt-16 mb-16 text-white p-10 bg-black bg-opacity-80 rounded-md shadow-md'>
          ...
          <form className='flex flex-col self-center justify-center mb-4'>
            ...
            />
            <button className="mb-5 px-4 py-2 w-full max-w-full text-base bg-red-600 hover:bg-red-700 text-white rounded border-none cursor-pointer align-middle" type="submit"
            onClick={() => {
              handleSubmit()
            }}>Sign Up</button>
