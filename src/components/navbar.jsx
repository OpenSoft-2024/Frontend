...
const NavBar = () => {
 ...
 let[color,setColor] = useState(false);
  ...
  return (
    <>
      <div
        className={`nav-box w-screen flex overflow-x-hidden overflow-y-hidden  px-8 items-center py-4 bg-eoio302   fixed  ${
      ...
      >
          ...
          <ul className="flex gap-10 capitalize mr-4 text-white mt-2">
            ...
            <li>
              <div className="languages cursor-pointer relative">
                ...
                {/* <div className="dropdown absolute " ref={dropDownContent}>
                  <ul className="text-white  px-4 py-4 rounded-lg flex flex-col gap-1 text-[13px] justify-center  ">
                    <div className="w-3/4 hover:bg-zinc-100 hover:text-[#df0707] rounded pl-2">
                      {" "}
                      <li>India</li>
                    </div>
                    <div className="w-3/4 hover:bg-zinc-100 hover:text-[#df0707] rounded pl-2">
        ...
        <div className="searchBox absolute top-[32%] left-[63%]   rounded-xl  bg-zinc-300 flex justify-center items-center">
          <input
            type="search"
            disabled
            className="w-[20rem] h-[2.4rem] bg-transparent  cursor-pointer searchBar00i px-4 pr-10  rounded outline-none text-white placeholder:capitalize"
